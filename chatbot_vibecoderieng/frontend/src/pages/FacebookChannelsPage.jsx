...
export default function FacebookChannelsPage() {
    ...
    async function handleToggleMultiBubble(id) {
        await fetch(`/api/v1/facebook/pages/${id}/toggle-multi-bubble`, { method: 'PUT' });
        fetchPages();
    }
    ...
    return (
        <div className="max-w-2xl space-y-6">
            <InfoCard title="Hướng dẫn kết nối Facebook">
                ...
                <p><strong>Multi-bubble:</strong> Khi bật, bot tách câu trả lời thành nhiều tin nhắn nhỏ (dùng dấu |||).</p>
            </InfoCard>
                ...
                <div className="space-y-3">
                    {pages.map(page => (
                        <FacebookPageCard
                            ...
                            onToggleMultiBubble={handleToggleMultiBubble}
                        />
                    ))}
                </div>
            )}
