...
import { Trash2, RefreshCw, Calendar, Users, Search, Download } from 'lucide-react';
    ...
    return (
        <div className="space-y-6">
            <InfoCard title="Hướng dẫn">
                <p>Danh sách khách hàng đã đăng ký qua chatbot. Lọc theo ngày hoặc tìm kiếm theo tên, SĐT, email.</p>
                <p>Nhấn <strong>Xuất CSV</strong> để tải toàn bộ danh sách về máy. Dùng nút <strong>Xóa</strong> để xóa từng bản ghi.</p>
            </InfoCard>

            {/* Toolbar */}
            <div className="flex justify-end gap-2">
                <button
                    onClick={() => window.open('/api/v1/registrations/export', '_blank')}
