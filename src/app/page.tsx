...
<div className="container mx-auto px-6 md:px-12 py-32 flex flex-col items-center text-center justify-center h-full">
    ...
    LÀM CHỦ<br/> <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-cyan-300">GOOGLE AI</span>
    ...
    <th className="py-5 px-6 bg-blue-600 font-bold text-white text-lg border-b border-blue-700 w-5/12">Google AI Ecosystem Bootcamp</th>
    ...
    <td className="py-4 px-6 text-slate-500 line-through decoration-red-500/50 text-slate-500 line-through">{row.o}</td>

    <td className="py-4 px-6 font-medium text-blue-800 bg-blue-900/20/50 flex items-start gap-2">
    ...
    <h2 className="text-blue-300 font-semibold tracking-wide uppercase text-sm"></h2>

    <h3 className="mt-2 text-3xl md:text-4xl font-bold">Đối Tượng Tham Gia</h3>
    ...
    <div className="w-14 h-14 bg-blue-600/20 border border-blue-500/30 rounded-xl flex items-center justify-center text-blue-400 mb-6 group-hover:scale-110 group-hover:bg-blue-600 group-hover:text-white transition-all shadow-lg shadow-blue-500/10">

    <role.icon size={28} />

    </div>

    <h4 className="text-xl font-bold mb-3">{role.title}<span className="text-blue-300/80 font-normal text-sm block mt-1">{}</span></h4>

    <p className="text-slate-300 leading-relaxed text-sm md:text-base">{role.desc}</p>
    ...
    <h2 className="text-blue-400 font-semibold tracking-wide uppercase text-sm flex items-center justify-center gap-2"><Zap size={16}/></h2>

    <h3 className="mt-2 text-3xl md:text-5xl font-bold text-white mb-6">BẢN ĐỒ HỆ SINH THÁI GOOGLE AI 2026</h3>
    ...
    <section id="lo-trinh" className="pt-24 bg-blue-900/20">
    ...
    <h3 className="mt-2 text-3xl md:text-4xl font-bold text-white">LỘ TRÌNH TINH GỌN 5 BUỔI</h3>

    <p className="mt-4 max-w-3xl mx-auto text-slate-400 text-lg">

    Dưới đây là nội dung tóm tắt chuyên nghiệp cho từng buổi học trong chương trình Google AI Ecosystem Bootcamp,được thiết kế nhằm giúp doanh nghiệp làm chủ hệ sinh thái AI của Googleđể tối ưu hóa hiệu suất và quy trình làm việc.
    ...
    className="text-yellow-500 text-3xl mb-6 flex justify-center gap-1 drop-shadow-md"
