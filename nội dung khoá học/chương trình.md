...
exportdefaultfunctionAIProgramCurriculum(){
  ...
  return(
    ...
    Nội DungChương Trình`<br/>`

    `<span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-indigo-500">`

    GoogleAI2026Bootcamp
    ...
    Chương trình đào tạo thực chiến được thiết kế hệ thống, giúp bạn làm chủ công nghệ và tựđộng hóa quy trình ngay tại lớp.
    ...
    {/* Màu nền box tham khảo độ tương phản từ ảnh mẫu (slate-900 / #0A1128) */}
    ...
    // Hiệu ứng trượt vào từ bên trái với độ trễ thác nước
    ...
    // Thiết kế Block: Có nền, viền bo góc tròn, hiệu ứng hover
    ...
    {/* Box chứa Icon cũng được làm nổi bật và có hiệu ứng phóng to khi hover khối */}
    ...
    {/* Căn chỉnh lại lề trái cho danh sách nằm vừa vặn trong Block */}
    ...
    {/* Căn chỉnh lại khoảng cách icon chevron với dòng text đầu tiên */}

    `<ChevronRight className="w-5 h-5 shrink-0 text-blue-500 mt-[2px]" />`

    `<span className="leading-relaxed text-sm md:text-base">`{item}
    ...
    {/* CỘT PHẢI: Thực hành & Kết quả (Chiếm 5 cột) - Nền khác biệt để nhấn mạnh */}
    ...
    `<span className="leading-relaxed">`{task}
    ...
    `<span className="leading-relaxed font-medium text-slate-200">`{outcome}
