...
For a complete implementation, see the tutorial below. ## [Tutorial: Build a SQL assistant with on-demand skillsLearn how to implement skills with progressive disclosure, where the agent loads specialized prompts and schemas on-demand rather than upfront.](/oss/python/langchain/multi-agent/skills-sql-assistant)
